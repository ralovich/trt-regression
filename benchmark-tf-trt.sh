...
benchmark_model --graph=model_100-tf-trt.pb --show_flops --input_layer=input_1_100_100_100_1 --input_layer_type=float --input_layer_shape=1,100,100,100,1 --output_layer=inception_v3_3d_1/output/sub_1
